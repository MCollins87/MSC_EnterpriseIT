---
layout: page
title: MSc Enterprise IT Management
subtitle: University of Essex Online | 2024-2026
---

This e-portfolio documents my academic, technical and reflective work completed as part of the **MSc Enterprise IT Management** programme at the University of Essex Online.

The programme has covered enterprise technology strategy, risk and security, IT service management, project management, data science, cloud operations and research methods, culminating in an independent MSc project.
...
[View module]({{ '/INDM/' | relative_url }}){: .button .alt}
...
[View module]({{ '/LEIM_PCOM7E/' | relative_url }}){: .button .alt}
...
[View module]({{ '/SRM/' | relative_url }}){: .button .alt}
...
[View module]({{ '/ITSM/' | relative_url }}){: .button .alt}
...
[View module]({{ '/EITPM/' | relative_url }}){: .button .alt}
...
[View module]({{ '/IDS/' | relative_url }}){: .button .alt}
...
[View module]({{ '/COM/' | relative_url }}){: .button .alt}
...
[View module]({{ '/RMPP/' | relative_url }}){: .button .alt}
...
[View MSc Project](https://github.com/MCollins87/MScProject){: .button}